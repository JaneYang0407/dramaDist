import { O as isBoolean, P as makeSymbol, Q as isPlainObject$1, R as isString$2, U as DEFAULT_LOCALE, V as isArray$2, W as isRegExp, X as isFunction$2, Z as updateFallbackLocale, _ as inBrowser, $ as createCompileError, a0 as assign$1, a1 as isNumber, a2 as create, a3 as deepCopy, a4 as hasOwn$1, a5 as createCoreContext, a6 as isObject$2, a7 as clearDateTimeFormat, a8 as clearNumberFormat, a9 as setAdditionalMeta, aa as getFallbackContext, ab as NOT_REOSLVED, ac as fallbackWithLocaleChain, ad as setFallbackContext, ae as CORE_ERROR_CODES_EXTEND_POINT, af as parseTranslateArgs, ag as translate, ah as MISSING_RESOLVE_VALUE, ai as parseDateTimeArgs, aj as datetime, ak as parseNumberArgs, al as number, am as isMessageAST, an as isMessageFunction, ao as NUMBER_FORMAT_OPTIONS_KEYS, ap as DATETIME_FORMAT_OPTIONS_KEYS, aq as isEmptyObject, ar as registerMessageCompiler, as as registerMessageResolver, at as registerLocaleFallbacker, au as getGlobalThis$1, av as setDevToolsHook, aw as compile, ax as resolveValue, ay as OverlayScrollbars, f as fromPairs } from "./vendor-3nH66FWi.js";
import { c as componentSizes } from "./element-plus-BqqwJ07U.js";
import { g as getParams, S as Swiper$1, e as extend$1, a as getChangedParams, u as updateSwiper, m as mountSwiper, n as needsNavigation, b as needsScrollbar, c as needsPagination, w as wrapperClass, d as uniqueClasses, f as updateOnVirtualData } from "./swiper-Bjhxao44.js";
/**
* @vue/shared v3.5.13
...
function getLocaleMessages(locale, options) {
  ...
  const ret = isPlainObject$1(messages) ? messages : isArray$2(__i18n) ? create() : { [locale]: create() };
  if (isArray$2(__i18n)) {
...
function convertComposerOptions(options) {
  ...
  const fallbackLocale = isString$2(options.fallbackLocale) || isArray$2(options.fallbackLocale) || isPlainObject$1(options.fallbackLocale) || options.fallbackLocale === false ? options.fallbackLocale : locale;
...
function useEventListener$2(...args) {
  ...
  const stopWatch = watchImmediate(
    () => {
      var _a2, _b;
      return [
        (_b = (_a2 = firstParamTargets.value) == null ? void 0 : _a2.map((e) => unrefElement$2(e))) != null ? _b : [defaultWindow$2].filter((e) => e != null),
...
function onClickOutside$1(target, handler, options = {}) {
  ...
  if (isIOS$1 && !_iOSWorkaround$1) {
    ...
    Array.from(window2.document.body.children).forEach((el) => useEventListener$2(el, "click", noop$1, listenerOptions));
    useEventListener$2(window2.document.documentElement, "click", noop$1, listenerOptions);
  }
  ...
  const cleanup = [
    ...
    useEventListener$2(window2, "pointerdown", (e) => {
      const el = unrefElement$2(target);
...
const g = () => {
  ...
  let a, t;
  const n = window, l = typeof n.requestIdleCallback == "function", s = n.requestAnimationFrame, r = n.cancelAnimationFrame, f = l ? n.requestIdleCallback : s, p2 = l ? n.cancelIdleCallback : r, e = () => {
    p2(a), r(t);
  };
  return [
    (o, m) => {
  ...
  setup(a, { expose: t, emit: n }) {
    const l = a, s = {
      ...
      scroll: "osScroll"
    }, { element: r, options: f, events: p2, defer: e } = toRefs(l), o = shallowRef(null), m = shallowRef(null), I = ref(), [E, O] = x({ options: f, events: I, defer: e });
    return t({
      osInstance: O,
      getElement: () => o.value
    }), watchPostEffect((c) => {
...
const getNormalizedProps = (node) => {
  ...
  const type = (isVNode$1(node.type) ? node.type.props : void 0) || {};
  const props = {};
...
const flattedChildren = (children) => {
  ...
  vNodes.forEach((child) => {
    ...
    } else if (isVNode$1(child) && isArray$1(child.children)) {
...
function getChildren(originalSlots, slidesRef, oldSlidesRef) {
  ...
  const getSlidesFromElements = (els, slotName) => {
    ...
    els.forEach((vnode) => {
      const isFragment2 = typeof vnode.type === "symbol";
      if (slotName === "default") slotName = "container-end";
      if (isFragment2 && vnode.children) {
...
export {
  ...
  hasOwn as aN,
  clock_default as aO,
  calendar_default as aP,
  arrow_up_default as aQ,
  d_arrow_left_default as aR,
  d_arrow_right_default as aS,
  getNormalizedProps as aT,
  PatchFlags as aU,
  composeRefs as aV,
  CloseComponents as aW,
  onScopeDispose as aX,
  useTimeoutFn as aY,
  refDebounced as aZ,
  TransitionGroup as a_,
  cloneVNode as aa,
  Text as ab,
  Comment as ac,
  unrefElement as ad,
  ...
  withNoopInstall as aq,
  isDate as ar,
  normalizeProps as as,
  guardReactiveProps as at,
  flattedChildren as au,
  isVNode$1 as av,
  arrow_left_default as aw,
  arrow_right_default as ax,
  toRaw as ay,
  vModelCheckbox as az,
  isArray$1 as b,
  createStaticVNode as b$,
  scale_to_original_default as b0,
  full_screen_default as b1,
  effectScope as b2,
  zoom_out_default as b3,
  zoom_in_default as b4,
  refresh_left_default as b5,
  refresh_right_default as b6,
  minus_default as b7,
  plus_default as b8,
  more_default as b9,
  search_default as bA,
  caret_right_default as bB,
  document_default as bC,
  delete_default as bD,
  useVModel as bE,
  useActiveElement as bF,
  createApp as bG,
  hyphenate as bH,
  shallowReactive as bI,
  withInstallFunction as bJ,
  isReactive as bK,
  getCurrentScope as bL,
  hasInjectionContext as bM,
  useRouter as bN,
  useRoute as bO,
  useI18n as bP,
  useEventListener$2 as bQ,
  RouterLink as bR,
  P as bS,
  OnClickOutside as bT,
  RouterView as bU,
  createRouter as bV,
  createMemoryHistory as bW,
  createWebHistory as bX,
  createI18n as bY,
  Swiper as bZ,
  SwiperSlide as b_,
  back_default as ba,
  isIOS as bb,
  isPlainObject as bc,
  resolveDirective as bd,
  toHandlerKey as be,
  useMutationObserver as bf,
  more_filled_default as bg,
  question_filled_default as bh,
  withInstallDirective as bi,
  warning_filled_default as bj,
  circle_check_default as bk,
  star_filled_default as bl,
  star_default as bm,
  info_filled_default as bn,
  circle_close_filled_default as bo,
  circle_check_filled_default as bp,
  picture_filled_default as bq,
  isFragment as br,
  isValidElementNode as bs,
  isValidComponentSize as bt,
  render as bu,
  sort_up_default as bv,
  sort_down_default as bw,
  useDocumentVisibility as bx,
  useWindowFocus as by,
  ensureOnlyChild as bz,
  computed as c,
  isObject$1 as d,
  isClient as e,
  isRef as f,
